                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('leads.store') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                            ...
                                            <option value="reached" {{ old('status') == 'reached' ? 'selected' : '' }}>{{ __('Reached') }}</option>
                                            <option value="interested" {{ old('status') == 'interested' ? 'selected' : '' }}>{{ __('Interested') }}</option>
                                            <option value="not interested" {{ old('status') == 'not interested' ? 'selected' : '' }}>{{ __('Not Interested') }}</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ __('Save Lead') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
