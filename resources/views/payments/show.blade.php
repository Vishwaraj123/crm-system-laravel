                ...
                <div class="col-md-8">
                    <div class="card shadow-sm border-0 rounded-4 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row mb-4">
                                <div class="col-6">
                                    <h6 class="text-muted text-uppercase x-small fw-bold mb-2">{{ __('Received From') }}</h6>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm border-0 rounded-4 mb-4">
                        <div class="card-body p-4 text-center">
                            ...
                            <p class="text-muted small mb-3">{{ __('Related to') }} {{ $payment->invoice->number }}</p>
                            ...
                            <div class="d-flex justify-content-between x-small fw-bold mb-4">
                                <span class="text-success">{{ __('Paid') }}: {{ number_format($payment->invoice->paid, 2) }}</span>
                                <span class="text-muted">{{ __('Total') }}: {{ number_format($payment->invoice->total, 2) }}</span>
                            </div>

                            <a href="{{ route('invoices.show', $payment->invoice) }}" class="btn btn-outline-primary w-100 rounded-pill">
                                {{ __('View Invoice') }}
                            </a>
                        </div>
                    </div>
