                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="company_name"
                                            class="form-label fw-semibold">{{ __('Company Name') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-6">
                                        <label for="company_email"
                                            class="form-label fw-semibold">{{ __('Company Email') }}</label>
                                        <input type="email"
                                    ...
                                    <div class="col-12">
                                        <label for="company_address"
                                            class="form-label fw-semibold">{{ __('Company Address') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-4">
                                        <label for="company_state"
                                            class="form-label fw-semibold">{{ __('State / Province') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-4">
                                        <label for="company_country"
                                            class="form-label fw-semibold">{{ __('Country') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-4">
                                        <label for="company_phone"
                                            class="form-label fw-semibold">{{ __('Company Phone') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-6">
                                        <label for="company_website"
                                            class="form-label fw-semibold">{{ __('Company Website') }}</label>
                                        <input type="url"
                                    ...
                                    <div class="col-md-6">
                                        <label for="company_tax_number"
                                            class="form-label fw-semibold">{{ __('Tax / VAT Number') }}</label>
                                        <input type="text"
                        ...
                        <div class="card shadow-sm border-0 mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="default_currency"
                                            class="form-label fw-semibold">{{ __('Default Currency') }}</label>
                                ...
                                <div class="alert alert-info mt-3 mb-0 py-2 small">
                                    ...
                                    Currency: <span id="currency-preview"
                                        class="fw-bold">{{ $settings['default_currency'] ?? 'USD' }} 1,234.56</span>
                                    &nbsp;|&nbsp;
                                    Date: <span id="date-preview"
                                        class="fw-bold">{{ now()->format($settings['date_format'] ?? 'd/m/Y') }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body text-center">
                                <div class="mb-3">
                                    @if (!empty($settings['company_logo']))
                                        <img src="{{ Storage::url($settings['company_logo']) }}" id="logo-preview"
                                            alt="Company Logo" class="img-fluid border p-2"
                                ...
                                <label for="company_logo"
                                    class="form-label fw-semibold d-block">{{ __('Upload New Logo') }}</label>
                                <input type="file"
